...
public final class GameConfig {
    ...
    public static final class Theme {
        ...
        public Theme() {
            this.bg = decode("#111827");
            this.grid = decode("#1f2937");
            this.snakeHead = decode("#34d399");
            this.snakeBody = decode("#10b981");
            this.snakeOutline = decode("#047857");
            this.snakeEye = decode("#f9fafb");
            this.snakePupil = decode("#111827");
            this.snakeTongue = decode("#ef4444");
            this.invincibleFlash = new Color[] {
                    decode("#fef08a"), decode("#f9fafb"), decode("#93c5fd"),
                    decode("#f0abfc"), decode("#86efac"),
            };
            this.invincibleOutline = decode("#facc15");
            this.invincibleWarningStipple = withAlpha(decode("#9ca3af"), 122);
            this.food = decode("#f97316");
            ...
            this.text = decode("#f9fafb");
            this.mutedText = decode("#9ca3af");
        }
